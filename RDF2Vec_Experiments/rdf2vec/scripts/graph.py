...
# https://raw.githubusercontent.com/IBCNServices/pyRDF2Vec/master/rdf2vec/graph.py
...
class KnowledgeGraph(object):
    ...
    def _create_label(self, vertex, n):
        neighbor_names = [self.label_map[x][n - 1] for x in self.get_neighbors(
                vertex)]
    ...
    def weisfeiler_lehman(self, iterations=3):
        ...
        for n in range(1, iterations+1):
            for vertex in self.vertices:
                ...
                # Store it in our label_map (hash trick from:
...
def extract_instance(kg, instance, depth):
